...
<div class="flex justify-between items-center mb-6">
    ...
    <div class="badge badge-warning px-4 py-2 text-lg">
        {{ $kodePesanan }}
    </div>
</div>

<form action="{{ route('admin.pesanan.store') }}" method="POST" id="form-pesanan">
    @csrf
        ...
        <div class="lg:col-span-1">
            <div class="card">
                <div class="card-header">
                    <h3 class="font-bold"><i class="fas fa-user text-primary"></i> Data Pelanggan</h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0" id="items-table">
                            ...
                            <tbody id="order-items">
                                ...
                                <tr class="item-row">
                                    <td>
                                        <select name="items[0][layanan_id]" class="form-control select-layanan" required onchange="calculateRow(this)">
                                        ...
                                        <input type="text" name="items[0][keterangan]" class="form-control mt-2 text-sm" placeholder="Keterangan tambahan (opsional)">
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <input type="number" name="items[0][jumlah]" class="form-control text-center input-jumlah" value="1" min="1" required onchange="calculateRow(this)" onkeyup="calculateRow(this)">
                                    </td>
                                    <td>
                                        <div class="input-group">
                                            <span class="text-sm font-bold text-gray-500 mr-1">Rp</span>
                                    ...
                                    <td class="text-center align-middle">
                                        <button type="button" class="text-red-500 hover:text-red-700 btn-remove-item" disabled>
                                ...
                                <tr class="bg-gray-50">
                                    ...
                                    <td class="text-right">
                                        <div class="input-group justify-end">
                                            ...
                                            <input type="text" id="total_biaya_display" class="border-0 bg-transparent p-0 text-right font-black text-2xl text-primary w-full" readonly value="0">
                                        </div>
                                    </td>
                                    <td></td>
                                </tr>
...
<script>
    ...
    window.calculateRow = function(element) {
        ...
        if (option && option.value) {
            ...
            // store raw subtotal for grand total calculation
    ...
    function updateRemoveButtons() {
        ...
        if (rows.length === 1) {
            ...
            // Remove onclick for first element
