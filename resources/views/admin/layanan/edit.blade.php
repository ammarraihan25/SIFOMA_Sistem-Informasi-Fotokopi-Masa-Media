        ...
        <div class="card-body">
            <form action="{{ route('admin.layanan.update', $layanan->id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="form-group">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="harga" id="harga" class="form-control pl-10" value="{{ old('harga', floatval($layanan->harga)) }}" min="0" required>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="form-group flex items-center gap-2">
                    <input type="checkbox" name="is_active" id="is_active" value="1" class="w-4 h-4 text-primary" {{ old('is_active', $layanan->is_active) ? 'checked' : '' }}>
