            ...
            <form action="{{ route('admin.kategori.update', $kategori->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="flex gap-2">
                        <input type="text" name="icon" id="icon" class="form-control" value="{{ old('icon', $kategori->icon) }}" placeholder="Contoh: fas fa-print">
                        <div class="w-12 h-12 shrink-0 bg-gray-100 rounded flex items-center justify-center text-xl text-gray-600" id="icon-preview">
                            <i class="{{ old('icon', $kategori->icon) }}"></i>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="urutan" id="urutan" class="form-control" value="{{ old('urutan', $kategori->urutan) }}" min="0">
                </div>
